package truyenconvert.server.modules.jwt.service;
...
public class JwtServiceImpl implements JwtService {
    ...
    public String generateAccessToken(UserDetails user){
        return buildToken(new HashMap<>(),user,Long.parseLong(accessTokenTime));
    }

    @Override
    public String generateRefreshToken(UserDetails user) {
        return buildToken(new HashMap<>(),user,Long.parseLong(refreshTokenTime));
    }
